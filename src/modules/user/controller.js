...
async function signup (req, res) {
    try {
        ...
        res.status(response.code).render("form", { signupError : response.message, signinError : ""})
    }
}
async function signin (req, res) {
    try {
       ...
       return
        ...
        res.status(response.code).render("form", { signupError : "", signinError : response.message })
